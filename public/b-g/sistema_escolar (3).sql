...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2025 a las 16:48:55
...
INSERT INTO `actividades` (`id_actividad`, `nombre_actividad`, `descripcion`, `fecha_creacion`) VALUES
(1, 'Waos', 'increible bro', '2025-06-06');
...
INSERT INTO `notas` (`id_nota`, `id_actividad`, `id_estudiante`, `nota`) VALUES
(1, 1, 1, 20.00);
...
(8, 4, 8, '245657', 'sadasd', 'yy', 'd', 'sw', '0412-1234567', 'adm@gol.com', '$2b$10$b83IfLy3Rcu.ommMdO8VVOrIGVKHs9cgLgMfhxOvXDdjq/.oxh.qq', 'pendiente', 1, '2025-06-06 23:21:44'),
(9, 2, 6, '123456789', 'lol', 'lol', 'lol', 'lol', '0412-1234567', 'admin@gol.com', '$2b$10$Q5MJY2KY/zpVZhOotsxu..8nPsqXztZuijTqb3SGVSGgb8TJEA4.e', 'admin', 1, '2025-06-10 13:47:36'),
...
(14, 3, 18, '123445', 'qww', '2', '2', '2', '0412-4532131', 'a@pr.com', '$2b$10$wKCIqjkT58YmD/E6w7QI5urZsxQPZSQgESuSh5cA1ZIiMlBjYpxX6', 'profesor', 1, NULL),
(15, 3, 19, '45645654', 'sa', 'g', 'b', 'n', '0414-4554254', 'wow@pr.com', '$2b$10$06KiPvjr.G27frDwsMDtte4nWRVAEmi6Sc8Zp5TL5Fw2WKYhqHc.u', 'profesor', 1, NULL),
(16, 3, 20, '45654545', '12', '123', '213', '45', '0412-4565454', '213@go.com', '$2b$10$wLq0RnEV.2mH.RIredTJb.ot0y3VZoXi0boKmkIgJBnlrCCWNXxe6', 'profesor', 1, NULL);
...
(20, 13, 1, '2025-06-09 03:23:50'),
(22, 12, 1, '2025-06-09 05:53:29'),
(37, 14, 3, '2025-06-10 05:37:02'),
(38, 15, 3, '2025-06-10 05:42:42'),
...
(7, 13, 2, '2025-06-08 23:23:50'),
(9, 12, 3, '2025-06-09 01:53:29'),
(24, 1, 3, '2025-06-09 14:08:40'),
(25, 14, 9, '2025-06-10 01:37:02'),
(26, 15, 9, '2025-06-10 01:42:43'),
(27, 16, 9, '2025-06-10 01:45:42');
...
--
ALTER TABLE `cursos_materias`
  MODIFY `id_curso_materia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `login`
  MODIFY `id_login` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `usuario_cursos`
  MODIFY `id_usuario_cursos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `usuario_materias`
--
ALTER TABLE `usuario_materias`
  MODIFY `id_usuario_materias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `usuario_periodo`
--
ALTER TABLE `usuario_periodo`
  MODIFY `id_usuario_periodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `usuario_seccion`
--
ALTER TABLE `usuario_seccion`
  MODIFY `id_usuario_seccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
